import { PartyList, PollingBox, Mandub, VoterData } from './election-context';

export const initialPartyLists: PartyList[] = [
  {
    id: 1,
...
export const initialPollingBoxes: PollingBox[] = [
...
export const initialMandubs: Mandub[] = [
  // Block 1 - المنية
  ...
  { id: 16, name: 'سامر رشيد عبد الله', block: '3', district: 'التل', recordNumber: 3007, religion: 'سني', phoneNumber: '71667788', phoneCardType: 'alfa', mandubType: 'مندوب جوال', representative: 'رامي رشيد', sex: 'ذكر' },
  { id: 17, name: 'مايا حسن صالح', block: '3', district: 'باب الرمل', recordNumber: 3008, religion: 'روم كاثوليك', phoneNumber: '71778899', phoneCardType: 'touch', mandubType: 'مندوب جوال سيارة', representative: 'دينا حسن', sex: 'أنثى' },
];

export const initialVoters: VoterData[] = [
  // Block 1 - المنية - مركز المنية الأول - غرفة 1
  ...
  // Block 1 - المنية - مركز المنية الأول - غرفة 2
  ...
  // Block 1 - المنية - مركز المنية الثاني - غرفة 1
  ...
  // Block 1 - المنية - مركز المنية الثاني - غرفة 2
  ...
  // Block 2 - الضنية - مركز الضنية المركزي - غرفة 1
  ...
  // Block 2 - الضنية - مركز الضنية المركزي - غرفة 2
  ...
  // Block 2 - الضنية - مركز الضنية المركزي - غرفة 3
  ...
  // Block 2 - الضنية - مركز الضنية الشرقي - غرفة 1
  ...
  // Block 2 - الضنية - مركز الضنية الشرقي - غرفة 2
